...
const fullHouse = new FullHouse({ score: 25, description: "2 are the same and 3 are the same" });

// small/large straights score as 30/40
const smallStraight = new SmallStraight({ score: 30, description: "4 in a sequential row" });
const largeStraight = new LargeStraight({ score: 40, description: "5 in a sequential row" });

// yahtzee scores as 50
const yahtzee = new Yahtzee({ score: 50, description: "All numbers are the same" });
